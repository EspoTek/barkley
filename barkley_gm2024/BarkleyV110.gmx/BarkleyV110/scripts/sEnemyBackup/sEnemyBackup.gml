function sEnemyBackup() {
	...
	with (oBattler) {
	if (point_distance(slav.x,slav.y,__view_get( e__VW.XView, 0 )+8+global.b_px[global.b_dd],__view_get( e__VW.YView, 0 )+4+global.b_py[global.b_dd])<48) { global.b_dd=-9; break; }
	}
