...
u_db_shadow = shader_get_uniform(shCRTDosbox, "u_shadow");
u_db_vig = shader_get_uniform(shCRTDosbox, "u_vig");
u_db_scan = shader_get_uniform(shCRTDosbox, "u_scan");
u_db_mask = shader_get_uniform(shCRTDosbox, "u_mask");
u_db_grain = shader_get_uniform(shCRTDosbox, "u_grain");
u_db_ghost = shader_get_uniform(shCRTDosbox, "u_ghost");
